...
class AboutClasses < EdgeCase::Koan
  ...
  class Dog7
    ...
    def to_s
      "Name of this object of class #{self.class}: #{@name}"
    end
  ...
  def test_to_s_provides_a_string_version_of_the_object
    fido = Dog7.new("Fido")
    assert_equal "Name of this object of class AboutClasses::Dog7: Fido", fido.to_s
  end

  def test_to_s_is_used_in_string_interpolation
    fido = Dog7.new("Fido")
    assert_equal "My dog is Name of this object of class AboutClasses::Dog7: Fido", "My dog is #{fido}"
  end
